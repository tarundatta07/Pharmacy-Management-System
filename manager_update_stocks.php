...
<html>
<head>
	<title> MANAGER UPDATE STOCKS PAGE </title>
...
<body>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				?>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="manager_add_medicine.php" class="button">ADD NEW MEDICINE</a> 

				<a href="manager_add_medicines.php" class="button">ADD MEDICINES THROUGH CSV FILE</a>
