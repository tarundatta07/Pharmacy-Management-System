...
<html>
<head>
	<title> ADMIN VIEW PHARMACIST PAGE </title>
...
<body>
	...
	<div id="homepage">
		...
		<div id="mainarea">
					...
					<h4> ADMIN - MANAGE PHARMACIST </h4>
					 ...
					 <?php
				        ...
				        {        
								...
								?>
								<td>&nbsp;&nbsp;
									<a href="admin_update_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/update-icon.png" width="35" height="35"/></a> 
									&nbsp;&nbsp;
									<a onclick="return confirm('Are you sure you want to delete Pharmacist : \'<?php echo $row['first_name'] ?> <?php echo $row['last_name']?>\' ?')" href="admin_delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/delete-icon.png" width="35px" height="35px"/></a>
								</td>
								</tr>
								<?php
						 } 
				...
				?>
				<a href="admin_add_pharmacist.php" class="button">ADD NEW PHARMACIST</a> <br>&nbsp;
				</div>
		</div>
