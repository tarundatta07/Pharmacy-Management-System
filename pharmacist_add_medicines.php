	  			...
	  			if(end($filename) == "csv")
	  			{
				   	...
				   	if(!$handle) 
				   	{
					    echo '<script type="text/javascript">
								...
								window.location.href = "pharmacist_add_medicines.php";
							   </script>';
					    exit();
					}
				   	$count = 0;
...
<html>
<head>
	<title> PHARMACIST ADD MEDICINES PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> PHARMACIST - ADD NEW MEDICINES </h4>
					
				<b id="title1">IMPORT/ ADD MEDICINES THROUGH A CSV FILE</b>
				<br>&nbsp;<br>&nbsp;<br>
				
            	<form name="add_medicines" action="pharmacist_add_medicines.php" method="post" autocomplete="OFF" enctype="multipart/form-data">
