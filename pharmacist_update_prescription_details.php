...
<html>
<head>
	<title> PHARMACIST UPDATE PRESCRIPTION DETAILS PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4 id="above"> PHARMACIST - UPDATE PRESCRIPTION DETAILS </h4>
					<?php 
					if(isset($_GET['pres_id']))
					{ ?>
				        ...
				        {        
								...
								?>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="pharmacist_update_pres_med.php?pres_id=<?php echo $pid ?>&med_name=<?php echo $row['medicine_name'] ?>"><img src="images/update-icon.png" width="35" height="35"/></a>
									&nbsp;&nbsp;
									<a onclick="return confirm('Are you sure you want to delete this Prescription detail with Medicine Name : \'<?php echo $row['medicine_name'] ?>\' ?')" href="pharmacist_delete_prescription_details.php?pres_id=<?php echo $pid ?>&med_name=<?php echo $row['medicine_name'] ?>"><img src="images/delete-icon.png" width="35" height="35"/></a>
								</td>
								</tr>
								<?php
						 } 
				        ...
				        echo"<br>";
				        ?><a href="pharmacist_update_pres.php?pres_id=<?php echo $pid; ?>" class="button">GO BACK</a>
				        <?php
						echo"<a href='#add' class='button'> ADD NEW MEDICINE</a>";
				        }
				        else
				        {
				        	echo"<br> <b id='nodata'> \"NO MEDICINES HAVE BEEN ADDED TO THIS PRESCRIPTION DETAIL\" </b><br><br>";
				        	?><a href="pharmacist_update_pres.php?pres_id=<?php echo $pid; ?>" class="button">GO BACK</a>
				        <?php echo"<a href='#add' class='button'> ADD NEW MEDICINE</a>";
				        }
					?>
					<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;
					<b id="top"> Add New Medicine Details of Customer "<?php echo $cust_name; ?>" with ID : <?php echo $pid; ?> </b>
						<br>&nbsp;<br>&nbsp;<br>
						<form name="add_pres" action="pharmacist_update_prescription_details.php" method="post" autocomplete="OFF">
