	 		...
	 		if($s_quantity>$s_stock_quantity)
	 		{
	 			echo '<script type="text/javascript">
						...
						alert("Quantity \'"+q+"\' Entered for Medicine \""+m+"\" exceeds currently available Stock...\nThe currently available Stock for Medicine \""+m+"\" is \'"+s+"\'");
								window.location.href = "pharmacist_update_pres_med.php?pres_id="+p+"&med_name="+m;
					   </script>';
	 		}
	 		else
	 		{
				...
				if(mysqli_query($con,$sql))
				{
					echo '<script type="text/javascript">
							...
							alert("Quantity Details of Prescription ID : \""+p+"\" with Medicine name \""+m+"\" has been Updated Successfully!"); 
								window.location.href = "pharmacist_update_prescription_details.php?pres_id="+p;
							</script>';
				}
				else
				{
...
<body>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<form name="update_pres_med" id="update_pres_med" action="pharmacist_update_pres_med.php" method="post" autocomplete="OFF">
        			...
        			<a href="pharmacist_update_prescription_details.php?pres_id=<?php echo $pid; ?>" class="button">GO BACK</a>
