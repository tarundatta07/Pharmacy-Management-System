...
<html>
<head>
	<title> CASHIER MANAGE INVOICES PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> CASHIER - MANAGE INVOICES </h4>
					
					 <?php
					 	$result = mysqli_query($con,"SELECT invoice_id, invoice_no, customer_name, payment_status, payment_type, DATE_FORMAT(date, '%d-%m-%Y') as date FROM invoice") or die(mysqli_error());
				        ...
				        $result = mysqli_query($con,"SELECT invoice_id, invoice_no, customer_name, payment_status, payment_type, DATE_FORMAT(date, '%d-%m-%Y') as date FROM invoice ORDER BY DATE(date) DESC") or die(mysqli_error());
				        ...
				        {        
								...
								?>
								<td>&nbsp;&nbsp;
									<a href="cashier_update_invoice.php?invoice_id=<?php echo $row['invoice_id']?>"><img src="images/update-icon.png" width="35" height="35"/></a> 
									&nbsp;&nbsp;
									<a onclick="return confirm('Are you sure you want to delete Invoice of \'<?php echo $row['customer_name'] ?>\' with ID : \'<?php echo $row['invoice_id'] ?>\' ?')" href="cashier_delete_invoice.php?invoice_id=<?php echo $row['invoice_id']?>"><img src="images/delete-icon.png" width="35" height="35"/></a>
								</td>
								</tr>
								<?php
						 } 
				    	...
				    	{
				    		echo"<br><br> <b id='nodatacashier'> \"NO INVOICE'S\" </b><br><br><br>";
						}						
				?>
