...
<html>
<head>
	<title> MANAGER VIEW CASHIER PAGE </title>
...
<body>
	...
	<div id="homepage">
		...
		<div id="mainarea">
					...
					<h4> MANAGER - MANAGE CASHIER </h4>
					 ...
					 <?php
				        ...
				        {        
								...
								?>
								<td>&nbsp;&nbsp;
									<a href="manager_update_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/update-icon.png" width="35" height="35"/></a> 
									&nbsp;&nbsp;
									<a onclick="return confirm('Are you sure you want to delete Cashier : \'<?php echo $row['first_name'] ?> <?php echo $row['last_name']?>\' ?')" href="manager_delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/delete-icon.png" width="35px" height="35px"/></a>
								</td>
								</tr>
								<?php
						 } 
				...
				?>
				<a href="manager_add_cashier.php" class="button">ADD NEW CASHIER</a> <br>&nbsp;
				</div>
		</div>
