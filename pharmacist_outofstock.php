...
<html>
<head>
	<title> PHARMACIST VIEW OUT OF STOCK PAGE </title>
		...
		<div id="mainarea">
				...
				<div id="sidebar">
						<center>
						 ...
						 <a href="pharmacist_outofstock.php" class="active"><img src="images/outofstock.png" height="20px" align="center">&nbsp;&nbsp;Out of Stock</a>
				...
				<div id="mainbox" align="center">
					<h4> PHARMACIST - MANAGE OUT OF STOCK </h4>
					
					<b>&nbsp; OUT OF STOCK MEDICINES : &nbsp;</b>
					 <?php
					 	$result = mysqli_query($con,"SELECT medicine_id, medicine_name, quantity, unit_price, DATE_FORMAT(expiry_date, '%d-%m-%Y') as expiry_date, medicine_status FROM medicine where quantity=0") or die(mysqli_error());
				        ...
				        {        
								...
								?>
								<td>&nbsp;&nbsp;
									<a href="pharmacist_update_medicine.php?medicine_id=<?php echo $row['medicine_id']?>"><img src="images/update-icon.png" width="35" height="35"/></a> 
									&nbsp;&nbsp;
									<a onclick="return confirm('Are you sure you want to delete Medicine : \'<?php echo $row['medicine_name'] ?>\' ?')" href="pharmacist_delete_medicine.php?medicine_id=<?php echo $row['medicine_id']?>"><img src="images/delete-icon.png" width="35" height="35"/></a>
								</td>
								</tr>
								<?php
						 } 
				    	...
				    	{
				    		echo"<br><br><br> <b id='nodata'> \"NO OUT OF STOCK MEDICINES\" </b><br>";
						}
				?>
				<br>&nbsp;
				</div>
