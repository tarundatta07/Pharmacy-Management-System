		...
		if(isset($_POST['submit']))
		{
			...
			if($password!=$cpass)
			{
				echo '<script type="text/javascript">
							...
							window.location.href = "manager_add_pharmacist.php";
						   </script>';
			}
			else
			{	
...
<html>
<head>
	<title> MANAGER ADD PHARMACIST PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> MANAGER - ADD NEW PHARMACIST </h4>
				<form name="add_pharmacist" id="add_pharmacist" action="manager_add_pharmacist.php" method="post" autocomplete="OFF">
					<table>
        				<tr> 
        					<th>Pharmacist ID</th> 
