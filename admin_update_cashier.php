				...
				$sql1=mysqli_query($con,"SELECT username FROM cashier WHERE username='$s_username'")or die(mysqli_error());
	 			...
	 			if($result1>0)
	 			{
					echo '<script type="text/javascript">
							...
							window.location.href = "admin_update_cashier.php?cashier_id="+u1;
						   </script>';
	 			}
 			}
...
<html>
<head>
	<title> ADMIN UPDATE CASHIER PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> ADMIN - UPDATE CASHIER <br>
						<span>-- Only modify details that you want to update --</span>
					</h4>
				<form name="update_cashier" id="update_cashier" action="admin_update_cashier.php" method="post" autocomplete="OFF">
					...
					<a href="admin_cashier.php" class="button">GO BACK</a>
