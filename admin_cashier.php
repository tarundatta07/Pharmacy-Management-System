...
<html>
<head>
	<title> ADMIN VIEW CASHIER PAGE </title>
		...
		<div id="mainarea">
				...
				<div id="sidebar">
						<center>
						 ...
						 <a href="admin_cashier.php" class="active"><img src="images/cashier.png" height="20px" align="center">&nbsp;&nbsp;Manage Cashier</a>
					...
					<h4> ADMIN - MANAGE CASHIER </h4>
					 ...
					 <?php
				        ...
				        {        
								...
								?>
								<td>&nbsp;&nbsp;
									<a href="admin_update_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/update-icon.png" width="35" height="35"/></a> 
									&nbsp;&nbsp;
									<a onclick="return confirm('Are you sure you want to delete Cashier : \'<?php echo $row['first_name'] ?> <?php echo $row['last_name']?>\' ?')" href="admin_delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/delete-icon.png" width="35px" height="35px"/></a>
								</td>
								</tr>
								<?php
						 } 
				    	...
				    	{
				    		echo"<br><br> <b id='nodatacashier'> \"NO CASHIER'S\" </b><br><br><br>";
						}
				?>
				<a href="admin_add_cashier.php" class="button">ADD NEW CASHIER</a> <br>&nbsp;
				</div>
		</div>
