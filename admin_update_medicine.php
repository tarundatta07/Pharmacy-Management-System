	 			...
	 			if($result1>0)
	 			{
					echo '<script type="text/javascript">
							var u;        
					 		...
					 		if(confirm == true)
	         				{ 
	             				window.location.href="admin_update_medicine.php?medicine_id="+u1;
	           				}
	           				else
	           				{
	           					alert("The Medicine Name Entered \""+u+"\" Already Exists! \nPlease Try Again with other Medicine name");
	           					window.location.href="admin_update_medicine.php?medicine_id="+u2;
	           				}
						   </script>';
...
<html>
<head>
	<title> ADMIN UPDATE MEDICINE PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					...
					?>
				<form name="update_medicine" action="admin_update_medicine.php" method="post" autocomplete="OFF">
					...
					<a href="admin_stocks.php" class="button">GO BACK</a>
