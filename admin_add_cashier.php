		...
		if(isset($_POST['submit']))
		{
			...
			if($password!=$cpass)
			{
				echo '<script type="text/javascript">
							...
							window.location.href = "admin_add_cashier.php";
						   </script>';
			}
			else
			{	
...
<html>
<head>
	<title> ADMIN ADD CASHIER PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> ADMIN - ADD NEW CASHIER </h4>
				<form name="add_cashier" id="add_cashier" action="admin_add_cashier.php" method="post" autocomplete="OFF">
					<table>
        				<tr> 
        					<th>Cashier ID</th> 
