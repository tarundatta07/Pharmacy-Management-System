...
<?php
		...
		{	
			$result1 = mysqli_query($con,"SELECT password FROM manager where manager_id=$id")or die(mysqli_error());
			...
			if($current_pass!=$password)
			{
				echo '<script type="text/javascript">
							...
							window.location.href = "manager_changepass.php";
						   </script>';
			}
			else
			{
				...
				{
					$sql="UPDATE manager SET password='$new_pass' WHERE manager_id='$id'";
...
<html>
<head>
	<title> MANAGER CHANGE PASSWORD PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="navbar" align="right">
					...
					<a href="manager_changepass.php" class="active"><img src="images/password.png" height="20px" align="center">&nbsp;&nbsp;Change Password</a>
					<a onclick="return confirm('Are you sure you want to log out?')" href="logout.php"><img src="images/logout.png" height="20px" align="center">&nbsp;&nbsp;Logout</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
				</div>
				...
				<div id="mainbox" align="center">
					<h4> MANAGER - CHANGE PASSWORD
					</h4>
					<?php 
						$result = mysqli_query($con,"SELECT manager_id, username FROM manager where manager_id=$id")or die(mysqli_error());
						$row = mysqli_fetch_array($result);
						$a=$row['manager_id'];
						$b=$row['username'];
					?>
				<form name="change_pass" action="manager_changepass.php" method="post" autocomplete="OFF">
					<table>
        				<tr> 
        					<th>Manager ID</th> 
