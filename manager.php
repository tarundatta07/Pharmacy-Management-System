...
<body>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="sidebar">
						<center>
						 ...
						 <a href="manager.php" class="active"><img src="images/dashboard.png" height="20px" align="center">&nbsp;&nbsp;Dashboard</a>
		...
		<div class="container">
		<!-- MANAGE PHARMACIST-->
			<div class="box" onclick="window.location.href = 'manager_pharmacist.php';">
				<div class="icon">
		 	...
		 	<!-- MANAGE CASHIER-->
			<div class="box" onclick="window.location.href = 'manager_cashier.php';">
				<div class="icon">
		 	...
		 	<!-- STOCKS (Medicines) -->
			<div class="box" onclick="window.location.href = 'manager_stocks.php';">
				<div class="icon">
		 	...
		 	<!-- OUT OF STOCK -->
			<div class="box" onclick="window.location.href = 'manager_outofstock.php';">
				<div class="icon">
		 	...
		 	<!-- EXPIRE SOON -->
			<div class="box" onclick="window.location.href = 'manager_expire.php';">
				<div class="icon">
		 	...
		 	<!-- EXPIRED -->
			<div class="box" onclick="window.location.href = 'manager_expire.php#expired';">
				<div class="icon">
		 	...
		 	<!-- TOTAL SALES -->
			<div class="box" onclick="window.location.href = 'manager_salesreport.php';">
				<div class="icon">
			...
			<div class="box" onclick="window.location.href = 'manager_salesreport.php';">
				...
				<div class="content">
					<h3>Sales Today</h3>
					<?php 
						$sql="SELECT a.pres_id, b.cost FROM prescription a, prescription_details b WHERE a.pres_id = b.pres_id AND a.invoice_no IN (SELECT invoice_no from invoice WHERE payment_status='Paid') AND DATE(a.date) = CURDATE() GROUP BY a.pres_id";
						$rowcount8="NA";
						if ($result=mysqli_query($con,$sql))
	  					{
