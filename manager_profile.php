	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="navbar" align="right">
					...
					<a href="manager_profile.php" class="active"><img src="images/userprofile.png" height="20px" align="center">&nbsp;&nbsp;User Profile</a>
				...
				<div id="mainbox" align="center">
					<h4> MANAGER - USER PROFILE </h4>
					<?php 
						$result = mysqli_query($con,"SELECT manager_id, username, first_name, last_name, address, phone, email_id FROM manager where manager_id=$id")or die(mysqli_error());
