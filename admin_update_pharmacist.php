				...
				$sql1=mysqli_query($con,"SELECT username FROM pharmacist WHERE username='$s_username'")or die(mysqli_error());
	 			...
	 			if($result1>0)
	 			{
					echo '<script type="text/javascript">
							...
							window.location.href = "admin_update_pharmacist.php?pharmacist_id="+u1;
						   </script>';
	 			}
 			}
...
<html>
<head>
	<title> ADMIN UPDATE PHARMACIST PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> ADMIN - UPDATE PHARMACIST <br>
						<span>-- Only modify details that you want to update --</span>
					</h4>
				<form name="update_pharmacist" id="update_pharmacist" action="admin_update_pharmacist.php" method="post" autocomplete="OFF">
