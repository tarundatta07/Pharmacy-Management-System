...
<html>
<head>
	<title> CASHIER GENERATE BILL PAGE </title>
		...
		<div id="mainarea">
				...
				<div id="sidebar">
						<center>
						 ...
						 <a href="cashier_generate_bill.php" class="active"><img src="images/bill.png" height="20px" align="center">&nbsp;&nbsp;Generate Bill</a>
				...
				<div id="mainbox" align="center">
					<h4> CASHIER - GENERATE BILL </h4>
					
					 <?php
					 	$result = mysqli_query($con,"SELECT invoice_id, invoice_no, customer_name, payment_status, payment_type, DATE_FORMAT(date, '%d-%m-%Y') as date FROM invoice WHERE payment_status='Paid'") or die(mysqli_error());
				        ...
				        $result = mysqli_query($con,"SELECT invoice_no, customer_name, payment_status, payment_type, DATE_FORMAT(date, '%d-%m-%Y') as date FROM invoice WHERE payment_status='Paid' ORDER BY DATE(date) DESC") or die(mysqli_error());
				        ...
				        {        
								...
								?>
								<td>
									<a class="pay" href="cashier_print_bill.php?invoice_no=<?php echo $row['invoice_no']; ?>">
     								   <img id="p" src="images/bill2.png" width="25" height="25" style="border: 0; float: left; margin: 5px 10px 5px 15px" /> 
        								<span id="s" style="border: 0; float: left; margin: 5px 15px 5px 0px">Bill</span>
   									</a>
								</td>
								</tr>
								<?php
				    	...
				    	{
				    		echo"<br><br> <b id='nodatabill'> \"NO INVOICE'S FOR GENERATING BILL\" </b><br><br><br>";
						}						
				?>
				 <a href='cashier_process_payment.php' class='button'>PROCESS PAYMENT</a>
