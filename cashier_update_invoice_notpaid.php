...
<?php
		...
		if(isset($_POST['submit']))
		{
				...
				$sql1=mysqli_query($con,"SELECT invoice_no, customer_name FROM invoice WHERE invoice_id='$s_invoice_id'")or die(mysqli_error());
	 			...
	 			if($result1>0)
	 			{
					echo '<script type="text/javascript">
							...
							window.location.href = "cashier_update_invoice_notpaid.php?invoice_id="+i;
						   </script>';
	 			}
 			}
			...
			{
				echo '<script type="text/javascript">
						window.location.href = "cashier_notpaid_invoices.php";
					  </script>';
			}
			else
			{
				...
				if(mysqli_query($con,$sql))
				{
					...
					echo '<script type="text/javascript">
							...
							if(s=="Paid")
							{
								...
								if(confirm == true)
								{
									window.location.href = "cashier_print_invoice2.php?invoice_no="+n;
								}
								else
								{
									window.location.href = "cashier_notpaid_invoices.php";
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					...
					?>
				<form name="update_invoice" action="cashier_update_invoice_notpaid.php" method="post" autocomplete="OFF">
					...
					<a href="cashier_notpaid_invoices.php" class="button">GO BACK</a>
