	 			...
	 			else
	 			{
					...
					else
					{
						...
						echo '<script type="text/javascript">
							      ...
							      window.location.href = "admin_add_medicine.php";
							 </script>';
					}
				}
		}
...
<html>
<head>
	<title> ADMIN ADD MEDICINE PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> ADMIN - ADD NEW MEDICINE </h4>
					
				<form name="add_medicine" action="admin_add_medicine.php" method="post" autocomplete="OFF">
					<table>
        				<tr> 
        					<th>Medicine ID</th> 
        			...
        			<a href="admin_add_medicines.php" class="button">ADD MEDICINES THROUGH CSV FILE</a><br> &nbsp;
				</form>
				</div>
		</div>
