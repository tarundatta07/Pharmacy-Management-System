	  			...
	  			if(end($filename) == "csv")
	  			{
				   	...
				   	if(!$handle) 
				   	{
					    echo '<script type="text/javascript">
								...
								window.location.href = "admin_add_medicines.php";
							   </script>';
					    exit();
					}
				   	$count = 0;
...
<html>
<head>
	<title> ADMIN ADD MEDICINES PAGE </title>
...
<body>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<h4> ADMIN - ADD NEW MEDICINES </h4>
					
				<b id="title1">IMPORT/ ADD MEDICINES THROUGH A CSV FILE</b>
				<br>&nbsp;<br>&nbsp;<br>
				
            	<form name="add_medicines" action="admin_add_medicines.php" method="post" autocomplete="OFF" enctype="multipart/form-data">
