	 			...
	 			else
	 			{
					...
					else
					{
						...
						echo '<script type="text/javascript">
							      ...
							      window.location.href = "pharmacist_add_medicine.php";
							 </script>';
					}
...
<html>
<head>
	<title> PHARMACIST ADD MEDICINE PAGE </title>
	...
	<div id="homepage">
		...
		<div id="mainarea">
				...
				<div id="mainbox" align="center">
					<h4> PHARMACIST - ADD NEW MEDICINE </h4>
					
				<form name="add_medicine" action="pharmacist_add_medicine.php" method="post" autocomplete="OFF">
					<table>
        				<tr> 
        					<th>Medicine ID</th> 
        			...
        			<a href="pharmacist_add_medicines.php" class="button">ADD MEDICINES THROUGH CSV FILE</a><br> &nbsp;
				</form>
				</div>
		</div>
